    ...
    <div className='main-container' style={{ backgroundColor: '#fafafa', padding: '120px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'row' }}>
        ...
        <div style={{ width: '20%', height: '100%', justifyContent: 'center', marginLeft: '30px' }}>
          <PDFGenerator />
          <hr style={{ margin: '30px 0', width: "90%", borderColor: 'lightgray' }} />
          <div>
            <Currency />
          </div>
          <div style={{ marginLeft:"45px", color:"green",  cursor:"pointer"}}>
            <h4>Save Defaults</h4>
          </div>
          <hr style={{ margin: '30px 0', width: "90%", borderColor: 'lightgray' }} />

          <button style={{marginLeft:"12px", backgroundColor: 'transparent', border: '1px solid gray', width: "160px", height:"37px", borderRadius:"5px", cursor:"pointer" }}>
              History
            </button>
        </div>
      </div>
